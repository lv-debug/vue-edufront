      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section class="p-h-video-box" id="videoPlay">
            <img :src="courseWebVo.cover" :alt="courseWebVo.title" style="height: 357px;" class="dis c-v-pic">
          </section>
        </article>
                  ...
                  <section class="mt20">
                    <div class="lh-menu-wrap">
                      <menu id="lh-menu" class="lh-menu mt10 mr10">
                        <ul>
                          <!-- 文件目录 -->
                          <li class="lh-menu-stair" v-for="chapter in chapterVideoByCourseId" :key="chapter.id">
...
export default {
  ...
  asyncData({ params , error }) {
    ...
    return courseApi.getCourseDescById(params.id).then(response =>{
